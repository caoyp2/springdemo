...
public class Bill {
    ...
    public Bill(Integer bid, String billCode, String billName, String billCom, Integer billNum, Double money, Integer pid, Provider provider, Integer pay, Date createDate) {
        this.bid = bid;
